...
- [x] 市/区级临床重点专科联网增强（**64 家医院 / 144 条**，新增 municipal_specialty 字段并在详情浮层展示；中医"十四五"首批 74 项全部抓齐）
- [x] 三层专科口径自洽（feature 擅长分级 → national_specialty 国家级 → municipal_specialty 市/区级，40 家 municipal_only 补足先前无国家级认定的三级医院）
