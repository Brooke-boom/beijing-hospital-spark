...
- [x] **科室数口径整治**（2026-09-20：发现百度百科**模板文字污染**——21 家首医系医院共用同一段词条简介「开放编制床位2500张；共设59个临床、医技科室」，被当成了各家真实的科室数；另有「局内设17个科室，所属机构包括社区矫正中心」实为**司法局**词条串入。新增模板污染检测 + 「数字紧邻上下文」口径判据，撤销 33 家污染值；列表与详情按「在线核实 / 登记科目 / 通用清单推导」三档标注来路，源数据收录不足的头部医院显示「科室资料待补全」而非假数字）
