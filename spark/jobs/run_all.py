...
数仓全链路编排入口
================================================================================
一次 SparkSession 串起 10 个阶段，避免反复启停 JVM：
...
import dim_dept_strength  # noqa: E402
...
STAGES = [
    ...
    ("deptstrength", "科室实力指数（就医决策）", dim_dept_strength.main,    True),
