...
数据源（均为联网核实/官方公开）：
  ...
  S3. 北京市中医管理局 首批"十四五"中医药重点专科名单（领超/示范/并超/建设/赶超/培育 共 74 项；当前已抓 28 项，其余待续抓）
...
# ============================================================ 数据源 S3：北京市中医管理局 首批"十四五"中医药重点专科（74 项目 — 当前已抓 28 项）
S3 = [
    # 领超类（已知 4 项；其余 6 项待补）
    ('领超', '中国中医科学院西苑医院', '心血管科'),
    ('领超', '中国中医科学院广安门医院', '肿瘤科'),
